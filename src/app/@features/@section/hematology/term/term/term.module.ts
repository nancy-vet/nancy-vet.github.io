...
import { TermDetailModal          } from '../term/@modal/term-detail/term-detail.component';
import { SelectCategoryModal      } from '../term/@modal/select-category/select-category.component';
